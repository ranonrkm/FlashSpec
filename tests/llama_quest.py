...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        if use_cache:
            ...
            if use_legacy_cache:
                self.config.cache_mode = None if not hasattr(self.config, "cache_mode") else self.config.cache_mode
                self.config.window = None if not hasattr(self.config, "window") else self.config.window
