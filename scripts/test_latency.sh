...
torchrun --standalone --nproc_per_node=1 --master_port=13456 tests/test_latency.py --M 4004 --declen_list 1 2 3 4 --P 4000 --B 16 --checkpoint_path checkpoints/meta-llama/Llama-2-7b-hf/model.pth --rank_group 0 --compile
