...
# torchrun --standalone --nproc_per_node=1 --master_port=13456 tests/test_latency.py --M 4096 --declen_list 1 2 3 4 --P 4000 --B 8 --checkpoint_path /home/jianc2/FastHesse/checkpoints/meta-llama/Llama-2-7b-hf/model.pth --rank_group 0 --compile

torchrun --standalone --nproc_per_node=1 --master_port=13456 tests/test_latency_draft.py --M 4096 --declen_list 1 2 3 4 --P 4000 --B 2 --rank_group 0 --compile
