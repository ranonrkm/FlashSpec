...
torchrun --standalone --nproc_per_node=1 --master_port=13456 tests/test_latency.py --M 16016 --declen_list 1 2 3 4 --P 16000 --B 16 --checkpoint_path checkpoints/gradientai/Llama-3-8B-Instruct-Gradient-1048k/model.pth --rank_group 0 --compile
torchrun --standalone --nproc_per_node=1 --master_port=13456 tests/test_latency.py --M 16016 --declen_list 1 2 3 4 --P 16000 --B 16 --checkpoint_path checkpoints/meta-llama/Llama-2-7b-hf/model.pth --rank_group 0 --compile
