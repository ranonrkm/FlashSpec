...
ENABLE_INTRA_NODE_COMM=1 torchrun --standalone --nproc_per_node=4 --master_port=13456 tests/longspec_benchmark.py --B 64 --target checkpoints/gradientai/Llama-3-8B-Instruct-Gradient-1048k/model.pth --model checkpoints/gradientai/Llama-3-8B-Instruct-Gradient-1048k/model.pth --rank_group 0 1 2 3 --draft_ranks 0 1 2 3 --gamma 3 --prefix_len 16000 --gen_len 90 --streamingllm_budget 256 --benchmark --compile
